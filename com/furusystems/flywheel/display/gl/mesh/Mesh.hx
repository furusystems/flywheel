package com.furusystems.flywheel.display.gl.mesh;
...
typedef Vertex = { pos:Float3, norm:Float3, binorm:Float3, uv:Float2, rgba:Color4 };
...
class Mesh
{
	...
	public static inline function createVertex(pos:Vector3D, norm:Vector3D, binorm:Vector3D, uv:Point, color:Color4):Vertex {
		return { pos: pos, norm: norm, binorm: binorm, uv: uv, rgba: color };
	}
