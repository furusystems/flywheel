...
class SimplexNoise {
	...
	private static var p:Array<Int> = new Array<Int>[
	...
	private static inline var sqrt3:Float = Math.sqrt(3);
	
	function SimplexNoise() {
		perm = new Array<Int>(512);
	...
	public inline function noise2D(x:Float, y:Float):Float {
